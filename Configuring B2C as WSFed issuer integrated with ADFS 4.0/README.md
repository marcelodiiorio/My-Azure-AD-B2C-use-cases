This scenario allows you to use Azure AD B2C as WSFed tokens issuer.

Important: WSFed tokens issuer capability is not yet available, so this scenario will not work for the moment, however, you can configure it in advance.
